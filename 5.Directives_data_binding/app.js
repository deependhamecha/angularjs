    ...
    // [] is dependencies.. like other services from angularjs.org like messages.. kind of like 'import'
    ...
    myApp.controller('mainController',function($scope,$filter) { //'$' sign does nothing..$scope is an object & its name has $ sign with it..nothing special..$scope is available in view under ng-controller
        ...
        // A directive is an instruction to angularjs to manipulate a piece of DOM.
        // which javascript/jquery also	does.
